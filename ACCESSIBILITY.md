...
The following issues are tracked as open GitHub issues. No new barriers should be introduced while these are open:

- [#4 Missing label for field search input](https://github.com/mgifford/openapi-reference/issues/4) — High
- [#5 Focus indicators removed with outline:none](https://github.com/mgifford/openapi-reference/issues/5) — High
- [#6 Skip navigation link missing](https://github.com/mgifford/openapi-reference/issues/6) — Medium
- [#7 innerHTML usage should be replaced with createElement](https://github.com/mgifford/openapi-reference/issues/7) — Medium
- [#8 Decorative emoji in headings lack aria-hidden](https://github.com/mgifford/openapi-reference/issues/8) — Low
